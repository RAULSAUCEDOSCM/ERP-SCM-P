...
IF DB_ID(N'ERP_SCM') IS NULL
BEGIN
    CREATE DATABASE ERP_SCM;
END
GO
...
BEGIN
    INSERT INTO dbo.Roles (RoleName, RoleDescription, IsSystem)
    VALUES (N'Compras', N'Operación del módulo de compras', 1);
END
GO
...
BEGIN
    INSERT INTO dbo.Roles (RoleName, RoleDescription, IsSystem)
    VALUES (N'Almacen', N'Operación del módulo de inventario y almacén', 1);
END
GO
...
BEGIN
    INSERT INTO dbo.Roles (RoleName, RoleDescription, IsSystem)
    VALUES (N'Ventas', N'Operación del módulo de ventas', 1);
END
GO
...
BEGIN
    INSERT INTO dbo.Modules (ModuleCode, ModuleName, ModuleDescription, SortOrder)
    VALUES (N'PURCHASES', N'Compras', N'Gestión de órdenes y proveedores', 3);
END
GO
...
BEGIN
    INSERT INTO dbo.Modules (ModuleCode, ModuleName, ModuleDescription, SortOrder)
    VALUES (N'SALES', N'Ventas', N'Pedidos, facturación y seguimiento comercial', 4);
END
GO
